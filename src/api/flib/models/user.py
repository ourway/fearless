...
from flib.models.mixin import IDMixin, Base, getUUID, logger, convert_to_datetime
from flib.models.helpers import expertizer, tag_maker, group_maker,\
...
class User(IDMixin, Base):
    ...
    agreements = relationship(
        "Document", backref='agreement_of', single_parent=True)
    payment_invoices = relationship(
        "Document", backref='invoice_of', single_parent=True)
