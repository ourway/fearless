...
prepare:
	...
	@yum install gcc nginx varnish redis rubygems libxslt-devel libxml2-devel libffi-devel python-devel openssl-devel postgresql-devel python-pip python-virtualenv pcre-devel python27 python27-devel -y
